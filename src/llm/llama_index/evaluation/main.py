...
def generate_results_dataframe(filtered_data: pd.DataFrame, original_data: pd.DataFrame) -> pd.DataFrame:
    """
    ...
    llm1_useful = ((filtered_data["Qual a melhor resposta?"] == "LLM 1") & 
                   (filtered_data["A melhor resposta foi útil?"] == "SIM")).sum()
    llm2_useful = ((filtered_data["Qual a melhor resposta?"] == "LLM 2") & 
                   (filtered_data["A melhor resposta foi útil?"] == "SIM")).sum()
