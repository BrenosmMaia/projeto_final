...
def main():
    ...
    ratio_results = process.extract(question, questions_faq, scorer=fuzz.ratio, limit=None, processor=utils.default_process)
    token_set_ratio_results = process.extract(question, questions_faq, scorer=fuzz.token_set_ratio, limit=None, processor=utils.default_process)
